...
cpu_moe = "auto"             # auto = offload only what doesn't fit (window sized first, leftover VRAM packed with experts); "on" forces ALL experts to RAM (max context); "off" disables; or a layer count
